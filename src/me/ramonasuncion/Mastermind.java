...
public class Mastermind
{
    ...
    public void initalizeCodeBreaker()
    {
        ...
        menuBarMain.getMenus().add(menu1);

        // Create the size of the bar
        menuBarMain.setPrefHeight(10.0);
        menuBarMain.setPrefWidth(1000.0);
        ...
        configGameMenuItem.setOnAction(new EventHandler<ActionEvent>()
        {
            @Override
            public void handle(ActionEvent event)
            {
